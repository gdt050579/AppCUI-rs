...
static HASH_TO_ALIGNAMENT: [Option<TextAlignament>; 9] = [
	Some(TextAlignament::Center),None,Some(TextAlignament::Right),Some(TextAlignament::Left),None,Some(TextAlignament::Center),Some(TextAlignament::Left),None,Some(TextAlignament::Right),
];

static HASH_COLISION_VALIDATOR: [u64; 9] = [
	0xAF63DE4C8601EFF2,0x0,0x76AAAA535714D805,0xAF63E14C8601F50B,0x0,0x6F4B7EC4DCAA8AC4,0x24B070ADA2041CB0,0x0,0xAF63EF4C86020CD5,
];

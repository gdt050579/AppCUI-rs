...
| ---------------------------------------------- | ------ | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `text` or `caption`                            | String | **Yes** (first positional parameter)   | The caption (text) of the checkbox. If the caption contains the special character `&`, the next character after it acts as a shortcut (meaning that pressing that character while that menu is open is equivalent to clicking that item). |
...
| `type`                                         | String | **No**                                | The type of the item (for a checkbox item, if this field is specified, its value must be `checkbox`).                                                                                                                                             |
...
The following methods are available for a `menu::CheckBox` object:

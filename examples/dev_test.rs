...
fn main() -> Result<(), appcui::system::Error> {
    ...
    let mut w = window!("Test,d:c,w:150,h:11,flags: Sizeable");
    ...
    let num_slider = NumericSlider::new(10, 100, 20, 30, Format::Decimal, Layout::new("x:1,y:2,w:100%"), Flags::SingleLine | Flags::HorizontalSlider);

...
fn main() -> Result<(), appcui::system::Error> {
    ...
    let mut b = BufferView::new(buffer, layout!("d:f"), bufferview::Flags::ScrollBars | bufferview::Flags::ShowAddress | bufferview::Flags::SearchBar  );
    b.set_columns_count(bufferview::ColumnsCount::Fixed(8));
    b.set_address_width(2);
    b.set_offset_format(bufferview::OffsetFormat::Dec);
    b.set_data_representation_format(bufferview::DataRepresentationFormat::Hex(bufferview::BytesCount::Four));

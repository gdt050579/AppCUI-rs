...
fn check_window_just_title() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("123456", layout!("a:c,w:20,h:10"), window::Flags::NoCloseButton)).run().unwrap();
}
...
fn check_window_pos() {
    ...
    ";
    App::new().size(Size::new(60, 14)).debug_script(script).window(|| Window::new("Centered", layout!("a:c,w:30,h:8"), window::Flags::NoCloseButton)).run().unwrap();
}
...
fn check_window_pos_using_layout_builder() {
    let script = "
        ...
        CheckHash(0x361C1A2F695D024B)
    ";
    App::new().size(Size::new(60, 14)).debug_script(script).window(|| Window::new(
        "Centered",
...
fn check_window_just_large_title() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("0123456789ABCD", layout!("a:c,w:20,h:10"), window::Flags::NoCloseButton)).run().unwrap();
}
#[test]
fn check_window_just_oversized_title() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("0123456789ABCDEFGH", layout!("a:c,w:20,h:10"), window::Flags::NoCloseButton)).run().unwrap();
}
#[test]
fn check_window_title() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("Title", layout!("a:c,w:20,h:10"), window::Flags::None)).run().unwrap();
}
#[test]
fn check_window_full_title_1() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("1234567890A", layout!("a:c,w:20,h:10"), window::Flags::None)).run().unwrap();
}
#[test]
...
fn check_window_full_title_3() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("ABC", layout!("a:c,w:12,h:8"), window::Flags::None)).run().unwrap();
}
#[test]
fn check_window_title_close_button_and_minimize_button() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("123456", layout!("a:c,w:20,h:8"), window::Flags::Sizeable)).run().unwrap();
}
#[test]
fn check_window_minimize_title_1() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("ABCDEFGHIJKL", layout!("a:c,w:20,h:10"), window::Flags::None)).run().unwrap();
}
#[test]
fn check_window_minimize_title_2() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("ABCDEFGHIJKL", layout!("a:c,w:16,h:8"), window::Flags::None)).run().unwrap();
}
#[test]
fn check_window_minimize_title_3() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("ABCDEFGHIJKL", layout!("a:c,w:14,h:6"), window::Flags::None)).run().unwrap();
}
#[test]
fn check_window_minimize_title_4() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| Window::new("ABCDEFGHIJKL", layout!("a:c,w:12,h:6"), window::Flags::None)).run().unwrap();
}
...
fn check_multiple_items_top_bar() {
    ...
    ";
    App::new().size(Size::new(80, 10)).debug_script(script).window(|| {
...
fn check_window_tag_1() {
    ...
    ";
    App::new().size(Size::new(20, 10)).debug_script(script).window(|| {
...
fn check_window_on_activate_deactivate() {
    ...
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).window(|| MyWin::new(layout!("x:1,y:1,w:25,h:6"))).window(|| MyWin::new(layout!("x:30,y:1,w:25,h:6"))).run().unwrap();
}
...
fn check_modal_window() {
    ...
    CheckHash(0x172AA26FB2F2488C)
    ";
    App::new().size(Size::new(60, 20)).debug_script(script).desktop(MyDesktop::new()).command_bar().run().unwrap();
}
...
fn check_window_fixed_pos() {
    ...
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).window(|| Window::new("Moveable", layout!("x:5,y:1,w:20,h:6"), window::Flags::None)).window(|| Window::new("Non-Moveable", layout!("x:30,y:1,w:25,h:6"), window::Flags::FixedPosition)).run().unwrap();
}
...
fn check_window_macro() {
    ...
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).window(|| window!("First,x:5,y:2,w:20,h:6")).window(|| window!("title='Test me',x:30,y:1,w:25,h:6,flags=[Sizeable,FixedPosition]")).run().unwrap();
}
...
fn check_window_resize_mode_keys() {
    ...
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).window(|| Window::new("Title", layout!("a:c,w:20,h:6"), window::Flags::Sizeable)).run().unwrap();
}
...
fn check_window_move_when_larger_than_terminal() {
    let script = "
        ...
        CheckHash(0x8A08E884EB4DC7F7)
    ";
    App::new().size(Size::new(80, 24)).debug_script(script).window(|| Window::new("Title", layout!("x:0,y:0,w:200,h:60"), window::Flags::Sizeable)).run().unwrap();
}
...
fn check_window_background() {
    ...
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).window(|| window!("Normal,x:0,y:0,w:30,h:5")).window(|| window!("Error,x:30,y:0,w:30,h:5,bg=Error")).window(|| window!("Notify,x:0,y:5,w:30,h:5,bg=Notification")).window(|| window!("Warning,x:30,y:5,w:30,h:5,bg=Warning")).run().unwrap();
}
...
fn check_window_on_close_default() {
    let script = "
        ...
        // CheckHash(0x8786A6E5A142320F)
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).window(|| window!("Win-1,x:0,y:0,w:30,h:5")).window(|| window!("Win-2,x:30,y:0,w:30,h:5")).run().unwrap();
}
...
fn check_window_close_with_commandbar_and_menu() {
    ...
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).command_bar().app_bar().window(|| MyWin::new()).run().unwrap();
}
...
fn check_procmacro_tag() {
    ...
    ";
    App::new().size(Size::new(40, 10)).debug_script(script).window(|| window!("Test,a:c,w:30,h:8,tag:'myWin'")).run().unwrap();
}
...
fn check_procmacro_auto_hotkey() {
    ...
    ";
    App::new().size(Size::new(80, 10)).debug_script(script).window(|| window!("Test,x:0,y:1,w:20,h:8,hotkey:auto")).window(|| window!("Test,x:20,y:1,w:20,h:8,hotkey:auto")).window(|| window!("Test,x:40,y:1,w:20,h:8,hotkey:auto")).window(|| window!("Test,x:60,y:1,w:20,h:8,hotkey:auto")).run().unwrap();
}
...
fn check_single_window() {
    ...
    ";
    App::new().size(Size::new(40, 10)).debug_script(script).single_window().window(|| window!("Test,x:0,y:1,w:10,h:8,hotkey:auto")).run().unwrap();
}
...
fn check_single_window_with_commandbar() {
    ...
    ";
    App::new().size(Size::new(40, 10)).debug_script(script).single_window().command_bar().window(|| window!("Test,x:0,y:1,w:10,h:8,hotkey:auto")).run().unwrap();
}
...
fn check_single_window_with_menubar() {
    ...
    ";
    App::new().size(Size::new(40, 10)).debug_script(script).single_window().app_bar().window(|| window!("Test,x:0,y:1,w:10,h:8,hotkey:auto")).run().unwrap();
}
...
fn check_single_window_with_menu_and_command_bar() {
    ...
    ";
    App::new().size(Size::new(40, 10)).debug_script(script).single_window().app_bar().command_bar().window(|| window!("Test,x:0,y:1,w:10,h:8,hotkey:auto")).run().unwrap();
}
...
fn check_single_window_panic_on_multiple_add_window() {
    let script = "
        ...
        CheckHash(0x0)
    ";
    App::new().size(Size::new(40, 10)).debug_script(script).single_window().window(|| window!("Test,x:0,y:1,w:10,h:8,hotkey:auto")).window(|| window!("Test,x:0,y:1,w:10,h:8,hotkey:auto")).run().unwrap();
}
...
fn check_single_window_panic_on_sizeable_flags() {
    let script = "
        ...
        CheckHash(0x0)
    ";
    App::new().size(Size::new(40, 10)).debug_script(script).single_window().window(|| window!("Test,x:0,y:1,w:10,h:8,flags:sizeable")).run().unwrap();
}
...
fn check_single_window_panic_no_window() {
    let script = "
        ...
        CheckHash(0x0)
    ";
    App::new().size(Size::new(40, 10)).debug_script(script).single_window().run().unwrap();
}
...
fn check_single_window_panic_no_custom_desktop() {
    ...
    let script = "
        ...
        CheckHash(0x0)
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).desktop(MyDesktop::new()).single_window().run().unwrap();
}
...
fn check_multiple_windows_focus() {
    let script = "
        ...
        CheckHash(0x97D61849202889DF)
    ";
    App::new().size(Size::new(60, 10)).debug_script(script).window(|| window!("Win1,x:1,y:1,w:30,h:5")).window(|| window!("Win2,x:11,y:3,w:30,h:5")).window(|| window!("Win3,x:21,y:5,w:30,h:5")).run().unwrap();
}
...
fn check_window_type_classic() {
    ...
    ";
    App::new().size(Size::new(90, 15)).debug_script(script).window(|| {

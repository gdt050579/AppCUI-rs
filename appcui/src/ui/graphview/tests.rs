...
fn check_arrange_hierarchical() {
    ...
    ";
    let mut a = App::new().size(Size::new(130, 15)).debug_script(script).run().unwrap();
    let mut w = window!("Test,d:f");
...
fn check_arrange_force_directed() {
    ...
    ";
    let mut a = App::new().size(Size::new(120, 30)).debug_script(script).run().unwrap();
    let mut w = window!("Test,d:f");
...
fn check_multi_graph_hierarchical() {
    ...
    ";
    let mut a = App::new().size(Size::new(130, 30)).debug_script(script).run().unwrap();
    let mut w = window!("Test,d:f");
    let mut gv = graphview!(
...
fn multiselect_space_three_nodes_then_ctrl_arrow_move_check_hash() {
    let script = "
        ...
        CheckHash(0x10703C77CBCDC451)
    ";
    let mut a = App::new().size(Size::new(72, 22)).debug_script(script).run().unwrap();
    let mut w = window!("Test,d:f");
    let mut gv = graphview!(

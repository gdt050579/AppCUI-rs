...
impl ControlLayout {
    ...
    #[inline]
    pub(crate) fn set_size_bounds(&mut self, min_width: u16, min_height: u16, max_width: u16, max_height: u16) {
    ...
    pub(crate) fn update(&mut self, parent_width: u16, parent_height: u16) {
        match self.mode {
            ...
            LayoutMode::PointAndSize(layout_mode) => layout_mode.update_control_layout(self, parent_width, parent_height),
            LayoutMode::LeftRightAnchors(layout_mode) => layout_mode.update_control_layout(self, parent_width, parent_height),
            LayoutMode::TopBottomAnchors(layout_mode) => layout_mode.update_control_layout(self, parent_width, parent_height),
            LayoutMode::LeftTopRightAnchors(layout_mode) => layout_mode.update_control_layout(self, parent_width, parent_height),
            LayoutMode::LeftBottomRightAnchors(layout_mode) => layout_mode.update_control_layout(self, parent_width, parent_height),
            LayoutMode::TopLeftBottomAnchors(layout_mode) => layout_mode.update_control_layout(self, parent_width, parent_height),
            LayoutMode::TopRightBottomAnchors(layout_mode) => layout_mode.update_control_layout(self, parent_width, parent_height),
            LayoutMode::AllAnchors(layout_mode) => layout_mode.update_control_layout(self, parent_width, parent_height),
        }
    }

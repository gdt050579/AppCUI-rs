...
fn check_init() {
    ...
    let mut tv = TreeView::new(layout!("a:c"), treeview::Flags::ScrollBars | treeview::Flags::SearchBar);
...
fn check_key_movement_up_down_without_header() {
    ...
    let mut a = App::debug(40, 10, script).build().unwrap();
    let mut w = window!("Test,a:c,w:100%,h:100%,flags: Sizeable");
    let mut tv = TreeView::new(layout!("a:c"), treeview::Flags::ScrollBars | treeview::Flags::HideHeader);
    Course::populate_with_courses(&mut tv);
    w.add(tv);
    a.add_window(w);
    a.run();
...
fn check_inactive() {
    ...
    let mut a = App::debug(60, 15, script).build().unwrap();
    let mut w = window!("Test,a:c,w:100%,h:100%,flags: Sizeable");
    let mut tv = TreeView::new(layout!("a:c"), treeview::Flags::ScrollBars | treeview::Flags::NoSelection);
...
fn check_small_icons() {
    ...
    let mut w = window!("Test,a:c,w:100%,h:100%,flags: Sizeable");
    let mut tv = TreeView::new(layout!("a:c"), treeview::Flags::ScrollBars | treeview::Flags::SmallIcons);
...
fn check_larger_icons() {
    ...
    let mut a = App::debug(60, 20, script).build().unwrap();
    let mut w = window!("Test,a:c,w:100%,h:100%,flags: Sizeable");
    let mut tv = TreeView::new(layout!("a:c"), treeview::Flags::ScrollBars | treeview::Flags::LargeIcons);
    Course::populate_with_icons(&mut tv);
    w.add(tv);
    a.add_window(w);
    a.run();
...
fn check_change_item_event() {
    ...
    impl MyWin {
        fn new() -> Self {
            ...
            let mut tv = TreeView::new(layout!("a:c"), treeview::Flags::None);
            Course::populate_with_icons(&mut tv);
            w.add(tv);
            w
        }
...
fn check_clear() {
    ...
    impl MyWin {
        fn new() -> Self {
            ...
            let mut tv = TreeView::new(layout!("a:c"), treeview::Flags::ScrollBars);
            Course::populate_with_icons(&mut tv);
            w.tv = w.add(tv);
            w
        }
...
fn check_empty_list() {
    ...
    let mut a = App::debug(60, 20, script).build().unwrap();
    let mut w = window!("Test,a:c,w:100%,h:100%,flags: Sizeable");
    let mut tv: TreeView<Course> = TreeView::new(layout!("a:c"), treeview::Flags::ScrollBars);
    tv.expand_all();
    tv.collapse_all();
    w.add(tv);
    a.add_window(w);

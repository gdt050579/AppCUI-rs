...
fn check_move_up_down() {
    let script = "
        ...
        Paint('shift down selects two lines')
        CheckHash(0xDA92FB54BCF3712A)
        CheckCursor(2,4)
        Key.Pressed(Shift+Up)
        Paint('shift up shrinks the selection back to one line')
        CheckHash(0x35C813E33104D586)
        CheckCursor(2,3)
        Key.Pressed(Shift+End)
        Key.Pressed(Shift+Home)
        Paint('shift home brings the selection back to the start of the line')
        CheckHash(0x35C813E33104D586)
        CheckCursor(2,3)
        Key.Pressed(Shift+PageDown)
        Paint('shift page down selects until the last line')
        CheckHash(0xDA92FB54BCF3712A)
        CheckCursor(2,4)
        Key.Pressed(Shift+PageUp)
        Paint('shift page up comes back over the anchor, the selection is empty again')
        CheckHash(0x3747D5EE36A2FD11)
        CheckCursor(2,2)
        Key.Pressed(Ctrl+End)
        Key.Pressed(Ctrl+Shift+Home)
        Paint('ctrl shift home selects the whole text backwards')
        CheckHash(0x1C9358996610DDFA)
        CheckCursor(2,2)
        Key.Pressed(Ctrl+Home)
        Key.Pressed(Ctrl+Shift+End)
        Paint('ctrl shift end selects the whole text forwards')
        CheckHash(0x1C9358996610DDFA)
        CheckCursor(16,4)
    ";
    App::new()

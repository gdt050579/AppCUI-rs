...
impl Rect {
    ...
    pub fn width_alignament(x: i32, y: i32, width: u16, height: u16, align: Alignament) -> Self {
        let x = match align {
            ...
            Alignament::TopRight => x - (width as i32),
            Alignament::Right => x - (width as i32),
            Alignament::BottomRight => x - (width as i32),
        ...
        let y = match align {
            ...
            Alignament::BottomRight => y - (height as i32),
            Alignament::Bottom => y - (height as i32),
            Alignament::BottomLeft => y - (height as i32),

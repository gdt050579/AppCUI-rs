...
impl MenuHandleManager {
    ...
    #[inline(always)]
    pub(crate) fn get_mut(&mut self, menu_handle: MenuHandle) -> Option<&mut Menu> {
        self.manager.get_mut(menu_handle.handle)
    }
    #[inline(always)]
    pub(crate) fn get(&mut self, menu_handle: MenuHandle) -> Option<&Menu> {
        self.manager.get(menu_handle.handle)
    }
    #[inline(always)]
    pub(crate) fn add(&mut self, menu: Menu) -> MenuHandle {

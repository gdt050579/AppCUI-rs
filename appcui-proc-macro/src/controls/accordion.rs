...
static mut ACCORDION_FLAGS: FlagsSignature = FlagsSignature::new(&["TransparentBackground"]);
...
pub(crate) fn create(input: TokenStream) -> TokenStream {
    ...
    cb.add_layout();
    cb.add_flags_parameter("flags", "accordion::Flags", unsafe { &mut ACCORDION_FLAGS });

...
static NAMED_PARAMETERS: &[NamedParameter] = &[
    ...
    NamedParameter::new("description", "tooltip", ParamType::Layout),
    NamedParameter::new("desc", "tooltip", ParamType::Layout),
    NamedParameter::new("tooltip", "tooltip", ParamType::Layout),

...
impl AppCUITrait {
    ...
    pub(crate) fn with_discriminant(value: u8) -> Option<AppCUITrait> {
        let result = match value {
            ...
            // raw events
            8 => Some(AppCUITrait::OnPaint),
            9 => Some(AppCUITrait::OnKeyPressed),
            10 => Some(AppCUITrait::OnMouseEvent),
            11 => Some(AppCUITrait::OnDefaultAction),
            12 => Some(AppCUITrait::OnResize),
            13 => Some(AppCUITrait::OnFocus),
            // control events
            14 => Some(AppCUITrait::ButtonEvents),
            15 => Some(AppCUITrait::CheckBoxEvents),
            16 => Some(AppCUITrait::WindowEvents),
            17 => Some(AppCUITrait::CommandBarEvents),
            18 => Some(AppCUITrait::MenuEvents),
            19 => Some(AppCUITrait::DesktopEvents),
            20 => Some(AppCUITrait::ToolBarEvents),
            _ => None,
        };
        if result.is_none() {
            return None;
